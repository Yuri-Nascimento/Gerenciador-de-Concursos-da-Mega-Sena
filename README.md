...
3 Estrutura dos dados
    ...
    um arquivo. Também é possível ocorrer leitura do teclado.

4 Arquivo de dados
    • O sistema deve permitir o carregamento de concursos a partir de um arquivo histó-
    rico.
...
5 Função de dispersão e colisões
    • Deve ser implementada uma função de dispersão que mapeie o número do concurso
    para um índice válido da tabela.
...
O sistema deve calcular e apresentar automaticamente:
    ...
    • A quantidade de concursos realizados em um determinado ano, com exibição de seus
    dados.
